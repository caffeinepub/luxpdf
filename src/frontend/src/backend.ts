...
export class Backend implements backendInterface {
    ...
    async getToolBySlug(arg0: string): Promise<Tool> {
        if (this.processError) {
            try {
    ...
    async getToolsByTier(arg0: string): Promise<Array<Tool>> {
        if (this.processError) {
            try {
                const result = await this.actor.getToolsByTier(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUsageStats(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
